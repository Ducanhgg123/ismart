                                ...
                                <tr>
                                    ...
                                    <td class="clearfix">
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="?mod=product&controller=category&action=delete&id=<?php echo $id?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                ...
                <div class="section-detail clearfix">
                    ...
                    <?php if ($total_page > 1) { ?>
                        <ul id="list-paging" class="fl-right">
                            <?php if ($total_page > 2) { ?>
                                <li>
                                    <a href="?mod=product&controller=category&page=<?php 1?>" title="" class="pagination">
                                        < </a>
                                </li>
                            <?php } ?>
